...
```{r top5MeanAbundance, echo=FALSE, eval=FALSE}
##  These were skewed by a few oddball OTUs, so resuts are given for medians. 
# mostAbu5 <- sort(colSums(rw.25)/sum(rw.25)*100), TRUE)[1:5]
# mostAbu5.m <- sort(colSums(rw.25[m, ])/sum(rw.25[m, ])*100, TRUE)[1:5]
# mostAbu5.f <- sort(colSums(rw.25[f, ])/sum(rw.25[f, ])*100, TRUE)[1:5]
# mostAbu5.p <- sort(colSums(rw.25[p, ])/sum(rw.25[p, ])*100, TRUE)[1:5]
# mostAbu5.fing <- sort(colSums(rw.25[finger, ])/sum(rw.25[finger, ])*100, TRUE)[1:5]
```
